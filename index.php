...
SESSION_START();
//create a re defined username and password
$acc_username = "blancojhoncarlo2@gmail.com";
$acc_password = "blanco123";
$acc_fullname = "John Carlo M. Blanco";
$acc_address = "Balogo, Boac, Marinduque";
...
if(isset($_REQUEST['login_button'])){
	//get the username and password form the form and compare to the prefefined username and password
