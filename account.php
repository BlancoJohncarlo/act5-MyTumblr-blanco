...
// start the session
SESSION_START();
// check if the session variable are set or the variable are existing
// this is to check if the account are still log in or not
...
.cover {
    background-image: url('images/cover-photo.avif');
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img src="images/profile-picture.avif" alt="..." width="150" class="
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    <p class="font-italic mb-0">Coding in C# programming</p>
